...
public class TelephonyManagerModule extends ReactContextBaseJavaModule
        implements TelephonyManagerListener.PhoneCallStateUpdate, LifecycleEventListener {

    private final ReactApplicationContext reactContext;
    private TelephonyManager telephonyManager;
    private TelephonyManagerListener telephonyPhoneStateListener;
    ...
    public TelephonyManagerModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void startListener(int events) {
        telephonyPhoneStateListener = new TelephonyManagerListener(this);
    ...
    public void stopListener() {
        ...
        telephonyManager.listen(telephonyPhoneStateListener, PhoneStateListener.LISTEN_NONE);
    ...
    public void getCellInfo(Callback successCallback) {
        ...
        for (CellInfo info : cellInfo) {
            ...
            if (info instanceof CellInfoGsm) {
                ...
                String localCellIdHex = cellIdHexIsEmpty ? "0"
                        : cellIdHex.substring(cellIdHex.length() - 2, cellIdHex.length());
    ...
    public void getPhoneInfo(Callback successCallBack) {
        ...
        mapPhoneInfo.putString("model", Build.MANUFACTURER + " " + Build.MODEL + " " + Build.VERSION.RELEASE + " "
